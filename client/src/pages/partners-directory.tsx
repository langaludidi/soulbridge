      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Connect with verified funeral service providers who understand South African traditions and can help you create meaningful digital memorials.
          </p>
        </div>
        ...
        <section className="mt-16 bg-primary/5 rounded-2xl p-8 md:p-12 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Connect with families in your community and help them create beautiful digital memorials for their loved ones.
            </p>
            <button className="bg-primary text-primary-foreground rounded-lg px-8 py-3 text-lg font-semibold hover:bg-primary/90 transition-colors" data-testid="button-become-partner">
              Become a Partner
            </button>
          </div>
        </section>
