              ...
              <div className="grid gap-3">
                <button 
                  onClick={() => {
                    toast({
                      title: "Flowers Laid",
                      description: `You've laid flowers on ${memorial.firstName}'s memorial. Your gesture of love will be remembered.`,
                      duration: 4000,
                    });
                  }}
                  className="flex items-center justify-center space-x-3 p-4 rounded-lg bg-primary/10 hover:bg-primary/20 transition-colors text-primary" 
                  data-testid="button-lay-flowers"
                >
                ...
                <button 
                  onClick={() => {
                    toast({
                      title: "Candle Lit",
                      description: `You've lit a candle for ${memorial.firstName}. May their light continue to shine in our hearts.`,
                      duration: 4000,
                    });
                  }}
