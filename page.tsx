      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mb-24 bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
            ...
            <div className="bg-gradient-to-br from-amber-50 to-stone-100 dark:from-gray-800 dark:to-gray-900 p-0 flex items-center justify-center overflow-hidden">
              <img
                src="/images/soulbridgenov1.png"
                alt="Hands holding a glowing candle in remembrance"
        ...
        <div className="mb-24">
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              <div className="bg-gradient-to-br from-amber-50 to-stone-100 dark:from-gray-800 dark:to-gray-900 p-0 flex items-center justify-center overflow-hidden order-2 lg:order-1">
                <img
                  src="/images/soulbridgenov2.png"
                  alt="Peaceful candles and pottery in serene setting"
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="p-8 lg:p-12 flex flex-col justify-center order-1 lg:order-2">
                <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">
                  A Space for Peaceful Remembrance
                </h2>
                <p className="text-gray-600 dark:text-gray-300 mb-4 text-lg">
                  SoulBridge provides a serene, dignified environment where families can gather, reflect, and celebrate the lives of their loved ones.
                </p>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  Every memorial is crafted with care, offering a beautiful, lasting tribute that brings comfort during difficult times and joy through cherished memories.
                </p>
                <p className="text-gray-600 dark:text-gray-300">
                  Whether sharing stories, lighting virtual candles, or simply visiting to remember, SoulBridge is here to support your journey of remembrance.
                </p>
              </div>
            </div>
          </div>
