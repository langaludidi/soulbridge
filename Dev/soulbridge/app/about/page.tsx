            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
              <div className="p-8 lg:p-12 flex flex-col justify-center">
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-4 text-lg">
                  At SoulBridge, we believe that every life tells a story worth preserving. Our mission is to provide families with a beautiful, dignified, and accessible way to honor their loved ones and keep their memories alive for generations to come.
                </p>
                <p className="text-gray-600 dark:text-gray-300 mb-4">
                  We understand that grief is a deeply personal journey, and we&apos;re here to support you every step of the way. Our platform is designed with compassion, respect, and sensitivity, ensuring that creating and sharing a memorial is a healing and meaningful experience.
                </p>
                <p className="text-gray-600 dark:text-gray-300">
                  Through SoulBridge, we aim to transform how we remember and celebrate the lives of those we&apos;ve lost, creating a lasting digital legacy that brings comfort, connection, and peace.
                </p>
              </div>
